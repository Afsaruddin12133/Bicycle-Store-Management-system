void bicycle_main_menu()
{
    int a;
    char* menu[]= {"  Sale Product","  Total Sale","  Add Stock","  View Stock","  Employs Attendents","   View Attendents" ,"  Exit"};
    system("cls");
    console_screen(40,85,23,31);
    gotocoordinate(60,18);
    printf("MAIN MENU");
    for (a=0; a<=5; a++)
    {
